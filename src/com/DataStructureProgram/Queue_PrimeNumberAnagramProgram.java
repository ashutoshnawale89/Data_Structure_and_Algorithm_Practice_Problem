...
public class Queue_PrimeNumberAnagramProgram {
		 ...
		 Node head;
			...
			//			System.out.println(tail.data+"->");
				...
				public static void main(String[] args) {
					System.out.println("Prime Numbers that are Anagram in the Range of 0 - 1000 in a Queue using");
					Queue_PrimeNumberAnagramProgram obj=new Queue_PrimeNumberAnagramProgram();
					primenu(1000);	
